...
class ArticleCleaner:
    ...
    def _clean_link(
        ...
        link = self._clean_required_text(
            raw,
            "link",
        )
    ...
    def _clean_date(
        ...
        *,
        ...
        parsed = self._parse_common_date(
            value,
            field,
        )
    ...
    def _normalize_to_utc(
        ...
        Naive datetimes are interpreted as UTC because the source has
        not provided timezone information. Timezone-aware datetimes are
        converted to UTC.
        """
    ...
    def _parse_common_date(
        ...
        """
        Parse common date representations.

        ISO 8601 dates are attempted first. A trailing 'Z' is converted
        to the explicit UTC offset expected by datetime.fromisoformat().
        """
